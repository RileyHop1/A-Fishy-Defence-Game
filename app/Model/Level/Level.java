...
import Model.Engine.ObserverPattern.SubjectRH;
...
public class Level implements SubjectRH, ObserverRH {
     ...
     */
    public void chooseMapSize(final int theMapSize) {
    ...
    public void generateBoard() {
        ...
        printBoard();
        //printMyCompletePath();
        notifyRH(LevelProperties.myMapUpdated);
     ...
     */
    private void createANewRandomPath() {
     ...
     */
    private void generatePath(final int[] theStartingPos, final int[] theEndPos) {
     ...
     */
    private void applyPath(final ArrayList<int[]> thePath) {
     ...
     */
    private void generateObstacle(final int[] theClusterCoords, final  int theDepth) {
     ...
     */
    public void printMyCompletePath() {
    ...
    /**
     * @return This returns the size of the map
     */
    ...
    @Override
    public void updateRH(String theUpdate) {

        switch (theUpdate) {

        }

        getInstance().generateBoard();
    }
}
